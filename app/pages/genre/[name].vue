  ...
  <main class="mx-auto flex max-w-6xl flex-col gap-6 p-6">
    <header class="space-y-1">
      <h1 class="font-display text-3xl font-bold leading-none tracking-tight text-slate-100 text-balance">
        {{ classificationName || 'Unknown' }}<span v-if="cityFromQuery"> — {{ cityFromQuery }}</span>
      </h1>
    ...
    <section v-else class="space-y-3">
      <h2 class="font-display text-xl font-semibold leading-tight tracking-tight text-slate-100 text-balance">Genre Events</h2>
